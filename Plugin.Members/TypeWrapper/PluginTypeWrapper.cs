...
namespace Plugin.Members.TypeWrapper
{
	internal class PluginTypeWrapper
	{
		...
		public Boolean IsValid { get => this._typeStrategy.IsValid; }

		public ICollection<PluginTypeWrapper> Members { get; private set; }

		private ICollection<PluginTypeWrapper> SubTypes { get; set; }

		public String TypeName { get => this._typeStrategy.TypeName; }

		public Boolean HasMembers { get => this._typeStrategy.HasMembers; }

		public Boolean IsContainer { get => this._typeStrategy.IsContainer; }

		public Boolean IsGeneric { get => this._typeStrategy.IsGeneric; }

		public Boolean IsEnum { get => this._typeStrategy.IsEnum; }

		public Boolean IsKeyValuePair { get => this._typeStrategy.IsKeyValuePair; }

		public Boolean IsStruct { get => this._typeStrategy.IsStruct; }
