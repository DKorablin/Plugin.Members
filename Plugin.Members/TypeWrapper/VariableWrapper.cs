...
namespace Plugin.Members.TypeWrapper
{
	...
	internal class VariableWrapper
	{
		...
		public Boolean IsValid { get => this._isValid; }
		...
		public String FriendlyTypeName { get => this.declaredMember.FriendlyTypeName; }
		...
		public String TypeName { get => this.declaredMember.TypeName; }
		...
		private static Boolean IsNullRepresentation(String str)
