...
namespace Plugin.Members.TypeWrapper
{
	...
	internal class TypeStrategy
	{
		...
		private Type ClientType { get => TypeStrategy.GetClientType(this.TypeName); }
		...
		public Boolean HasMembers { get => this._typeProperty.IsGeneric || this._typeProperty.IsNullable || this._typeProperty.IsKeyValuePair; }

		public Boolean IsContainer { get => this._typeProperty.IsArray || this._typeProperty.IsDictionary || this._typeProperty.IsCollection; }

		public Boolean IsGeneric { get => this._typeProperty.IsGeneric; }

		public Boolean IsEnum { get => this._enumChoices != null; }

		public Boolean IsKeyValuePair { get => this._typeProperty.IsKeyValuePair; }

		public Boolean IsStruct { get => this._typeProperty.IsStruct; }
