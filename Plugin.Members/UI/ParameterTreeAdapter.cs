	...
	internal class ParameterTreeAdapter : IMultiColumnBranch, IBranch
	{
		...
		private sealed class ChoiceConverter : StringConverter
		{
			...
			public override TypeConverter.StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
				=> new TypeConverter.StandardValuesCollection(ParameterTreeAdapter.ChoiceConverter.StaticChoices);

			public override Boolean GetStandardValuesExclusive(ITypeDescriptorContext context)
				=> ParameterTreeAdapter.ChoiceConverter.StaticExclusive;
		...
		public Int32 ColumnCount { get => 3; }
		...
		public Int32 UpdateCounter { get => 0; }
		...
		public LabelEditResult CommitLabelEdit(Int32 row, Int32 column, String newText)
		{
			...
			if(!validation.IsValid)
			{
				if(validation.ErrorMessage != null)
					MessageBox.Show(validation.ErrorMessage, "StringResources.ProductName", MessageBoxButtons.OK, MessageBoxIcon.Hand, MessageBoxDefaultButton.Button1);
		...
		public Object GetObject(Int32 row, Int32 column, ObjectStyle style, ref Int32 options)
		{
			...
			if(this.IsExpandable(row, column))
				return this._children[row] = new ParameterTreeAdapter(this._virtualTree, this._virtualTreeControl, this._variables[row].GetChildVariables(), this._readOnly, this);
			return null;
		}
